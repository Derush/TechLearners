...
import com.dreamon.techlearners.repository.OlSubjectRepositorty;
...
@Controller
public class notQualController {
    @Autowired
    streamRepository st;
    @Autowired
    ...
    @RequestMapping("/notQual")
    public String coursesShow(Model model) {

        return "notQual";
    }

    @RequestMapping(name = "/ar", value = "/ar", method = RequestMethod.POST)
    ...
    @RequestMapping(name = "/oth", value = "/oth", method = RequestMethod.POST)
    ...
    @RequestMapping(name = "/com", value = "/com", method = RequestMethod.POST)
